...
class IncidenciaModel extends Conexion
{
  ...
  public function listarIncidenciasAdministrador()
  {
    ...
    try {
      if ($conector != null) {
        ...
        INC_asunto, ARE_nombre, INC_descripcion, INC_documento, INC_codigoPatrimonial
  ...
  // public function buscarIncidenciaAdministrador($codigoArea, $estado, $fechaInicio, $fechaFin)
  // {
