  ...
  <div class="pcoded-content">
    ...
    <div class="row">
      ...
      <div class="col-md-12 col-xl-4">
        <div class="card support-bar overflow-hidden">
          <div class="card-body pb-0">
            <!-- aqui se contara el total de incidencias en el mes -->
      ...
      <script>
        ...
        var incidenciasData = <?php echo json_encode([$cantidades['pendientes_mes_actual'], $cantidades['recepciones_mes_actual'], $cantidades['cierres_mes_actual']]); ?>;
