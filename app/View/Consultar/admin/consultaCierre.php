<div class="pcoded-main-container">
  <div class="pcoded-content">
    ...
    <form id="formConsultarCierre" action="modulo-rol.php" method="POST" class="border bg-white shadow-md p-6 w-full text-xs rounded-md mb-4">
    ...
    <div class="relative shadow-md sm:rounded-lg">
      <div class="max-w-full overflow-hidden">
        <table id="tablaConsultarCierres" class="w-full text-xs text-left rtl:text-right text-gray-500">
