<div class="pcoded-main-container overflow-y-auto">
  <div class="pcoded-content overflow-y-auto">
    ...
    <!-- TODO: FORMULARIO -->
    <form id="formIncidencia" action="registro-incidencia-user.php?action=registrar" method="POST" class="border bg-white shadow-md p-6 w-full text-xs rounded-md">
      ...
      <div class="flex flex-wrap -mx-2">
        ...
        <div class="w-full sm:w-1/6 px-2 mb-2 ">
          <label for="area" class="block mb-1 font-bold text-xs">C&oacute;digo &Aacute;rea:</label>
          <input type="text" id="area" name="area" class="border border-gray-200 bg-gray-100 p-2 w-full text-xs" value="<?php echo $_SESSION['codigoArea']; ?>" readonly>
        </div>
        ...
        <div class="w-full md:w-1/6 px-2 mb-2">
          <label for="usuario" class="block font-bold mb-1 text-xs">C&oacute;digo Usuario:</label>
      ...
      <div class="flex flex-wrap -mx-2">
        ...
        <div class="w-full sm:w-1/2 px-2 mb-2">
          <label for="categoria" class="block font-bold mb-1 text-xs">Categor&iacute;a:</label>
