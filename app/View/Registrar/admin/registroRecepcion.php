    ...
    <form id="formRecepcion" action="registro-recepcion.php?action=registrar" method="POST" class="card table-card bg-white shadow-md p-4 w-full text-xs mb-3">
      ...
      <div class="flex flex-wrap -mx-2 justify-center">
        ...
        <div class="flex justify-center items-center space-x-4 mt-3 ml-5">
          <button type="submit" id="guardar-recepcion" class="bn btn-primary text-xs text-white font-bold py-2 px-3 rounded-md disabled:cursor-not-allowed"><i class="feather mr-2 icon-save"></i>Guardar</button>
          <button type="button" id="editar-recepcion" class="bn btn-info text-xs text-white font-bold py-2 px-3 rounded-md disabled:cursor-not-allowed" disabled><i class="feather mr-2 icon-edit"></i>Editar</button>
