<div class="pcoded-main-container mt-5">
  <div class="pcoded-content">
    <?php
    global $personaUsuarioRegistrado;
    ...
    <div class="flex space-x-4">
      <!-- Inicio de Formulario de registro de usuarios -->
      <div class="flex flex-col w-1/3">
        <form id="formUsuario" action="modulo.php?action=registrar" method="POST" class="card table-card bg-white shadow-md p-6 text-xs  flex flex-col mb-2">
