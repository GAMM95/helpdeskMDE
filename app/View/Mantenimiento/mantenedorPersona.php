        ...
        <form id="formPersona" action="modulo-persona.php?action=registrar" method="POST" class="card table-card bg-white shadow-md p-6 text-xs  flex flex-col mb-2">
          ...
          <div class="card-body">
            ...
            <div class="flex justify-center space-x-4 mt-3">
              ...
              <button type="button" id="nuevo-registro" class="bn btn-secondary text-xs text-white font-bold py-2 px-3 rounded-md" disabled> <i class="feather mr-2 icon-plus-square"></i>Limpiar</button>
            </div>
          </div>
