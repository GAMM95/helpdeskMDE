      ...
      <div class="flex flex-col w-1/3">
        <form id="formArea" action="modulo-area.php?action=registrar" method="POST" class="card table-card bg-white shadow-md p-6 w-full text-xs">
          ...
          <div class="flex justify-center space-x-4">
            ...
            <button type="button" id="editar-area" class="bn btn-info text-xs text-white font-bold py-2 px-3 rounded-md" disabled><i class="feather mr-2 icon-edit"></i>Guardar cambios</button>
