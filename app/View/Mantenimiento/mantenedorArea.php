    ...
    <div class="pcoded-content">
      ...
      <div class="flex space-x-4">
        ...
        <div class="flex flex-col w-1/3">
          <form id="formarea" action="modulo-area.php" method="POST" class="border bg-white shadow-md p-6 w-full text-xs rounded-md">
            ...
            <div class="flex flex-wrap -mx-2">
              <div class="w-full px-2 mb-3">
                ...
                <input type="text" id="txt_nombreArea" name="NombreArea" class="border p-2 w-full text-xs" pattern="[A-Za-z]+" placeholder="Ingrese nueva &aacute;rea" required>
              </div>
            </div>
